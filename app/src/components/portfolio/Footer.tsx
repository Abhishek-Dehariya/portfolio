    ...
    <footer className="relative border-t border-border/60 mt-12">
      <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 text-muted-foreground">
          ...
          <a href="https://linkedin.com/in/abhishek-dehariya-02404911a" aria-label="LinkedIn" className="hover:text-primary transition-colors">
            <LinkedinIcon className="size-4" />
          </a>
          <a href="mailto:a.dehariya10@gmail.com" aria-label="Email" className="hover:text-primary transition-colors">
